...
> **[已归档 2026-09-04]** 本计划基于 v2.0.4（commit `2c54bd0`）编写，属历史文档，内容不再随版本更新。
> 其中阶段 0（CONTRIBUTING / CI / PR 模板 / 版本号对齐）已全部落地；T1~T9 的现行状态
> 与后续计划以根目录 [TODO.md](../../TODO.md) 为唯一权威；实证审计见
> [2026-08-31-sync-audit.md](2026-08-31-sync-audit.md)。
